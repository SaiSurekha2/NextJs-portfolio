...
const TAB_DATA=[
    ...
    },
    {
        ...
        content:(
            <ul className="list-disc pl-2">
                ...
                <li>G. PullaReddy Engineering College</li>
    ...
    },
    {
        ...
        id:"certifications",
        content:(
            <ul className="list-disc pl-2">I completed my training on full stack in BlendVidya</ul>
        )
    }
]
const AboutSection = () => {
        ...
        <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:py-16">
            ...
            <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
                ...
                <p className="text-base md:text-lg">
                    ...
                    I have experience working with JavaScript, React, Node.js, PostgreSQL,HTML,CSS. I am a qucik learner and 
                    I am always looking to expand my knowledge and skill set. I am a team player and I am excited to work with 
